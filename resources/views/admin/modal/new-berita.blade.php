<div class="modal fade new-berita" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myLargeModalLabel">Berita Baru</h4>
					...
					<div class="row">
						<div class="col-12">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input class="form-control" type="text" value="Judul" id="judul">
								</div>
							</div>
							<div class="form-group row">
								<label for="example-search-input" class="col-sm-2 col-form-label">Sumary</label>
								<div class="col-sm-10">
									<input class="form-control" type="text" value="Summary" id="summary">
								</div>
							</div>
							<div class="form-group row">
								<div class="row">
							...
							<div class="form-group">
								<label>Gambar Banner (1080 resolusi minimal)</label>
								<label class="file">
